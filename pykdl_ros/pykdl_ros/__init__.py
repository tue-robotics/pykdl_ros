...
class FrameStamped:
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, FrameStamped):
            return self.frame == other.frame and self.header.frame_id == other.header.frame_id  # type: ignore[no-any-return,unused-ignore]
        return False
...
class TwistStamped:
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, TwistStamped):
            return self.twist == other.twist and self.header.frame_id == other.header.frame_id  # type: ignore[no-any-return,unused-ignore]
        return False
...
class VectorStamped:
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, VectorStamped):
            return self.vector == other.vector and self.header.frame_id == other.header.frame_id  # type: ignore[no-any-return,unused-ignore]
        return False
...
class WrenchStamped:
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, WrenchStamped):
            return self.wrench == other.wrench and self.header.frame_id == other.header.frame_id  # type: ignore[no-any-return,unused-ignore]
        return False
